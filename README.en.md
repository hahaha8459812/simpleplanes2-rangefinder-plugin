...
Download `SimplePlanes2Rangefinder-Release.zip` from the [releases page](https://github.com/hahaha8459812/simpleplanes2-rangefinder-plugin/releases/latest) and put `SimplePlanes2Rangefinder.dll` in any subfolder of `BepInEx\plugins\`; we recommend one folder per plugin:
